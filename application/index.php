...
<title>Ventura</title>
 ...
 <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Ventura
            <span class="text-primary">Viagens</span>
          </h1>
          <div class="subheading mb-5">Contato:
            <a href="mailto:name@email.com">bgbasoftware@gmail.com</a>
          </div>
          <p class="lead mb-5">Software de Gerenciamento de Viagens frente ao Instituto Federal Goiano Campus Ceres</p>
