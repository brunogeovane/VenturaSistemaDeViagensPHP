...
<table class="table">
  <thead>
    <tr>
      <th scope="col">Minhas Viagens</th><br>
...
foreach(Crud::viagensInscritas() as $viagem){
...
<input type="checkbox" name="iddaviagem" value="<?php echo $viagem["idViagem"] ?>"> Selecione está viagem 
	 ...
	 <td><br><input class="btn btn-danger" scope="row" type='submit' value='Cancelar Inscrição'><br><hr><br></td>
     </tr>
    </tr>
	</form>
