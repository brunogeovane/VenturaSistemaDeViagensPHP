...
<form action='verificarloginadm.php' method='POST'>
      <h2><i>Email:</i></h2>
      <input name="email" type="email" id="email" value=""/> 
      <h2><i>Senha:</i></h2>
      <input name="senha" type="password" id="senha" value=""/><br><br>
      <a  onclick="toogle_disabled href="newAdm.php" class="btn btn-outline-warning ">Criar Conta</a>
